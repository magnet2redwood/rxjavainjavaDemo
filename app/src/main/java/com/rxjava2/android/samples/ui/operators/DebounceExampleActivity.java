...
public class DebounceExampleActivity extends AppCompatActivity {
    ...
    private static final String TAG = "sujay"+DebounceExampleActivity.class.getSimpleName();
    Button btn;
    TextView textView;
    ...
    * passed without it emitting another item, so it will emit 1,2, 4, 5 as we have simulated it.
    */
